...
切换到UDP的另一个令人兴奋的机会是您不再依赖于连接的*源IP*。
...
自2014年以来，Chrome浏览器一直支持QUIC（实验性）。如果您想要测试QUIC，[可以在Chrome中启用协议](https://ma.ttias.be/enable-quic-protocol-google-chrome/)。实际上，您只能针对Google服务测试QUIC协议。
